          ...
          <div className="desktop:mt-12 mt-12 flex desktop:flex-row flex-col desktop:gap-y-0 gap-y-6 desktop:justify-between">
            {ROADMAP.ITEMS.map((data, key) => {
              ...
              return (
                <div
                  key={data.TITLE}
                  className={`flex desktop:flex-col justify-around gap-y-4 text-white ${
                ...
                >
                  <div className="relative flex items-center">
                    <div className="flex items-center relative">
                      ...
                      />
                      {DONE && (
                        <div className="absolute -top-2 -right-2 -bottom-2 -left-2 border-4 border-red-100 rounded-full" />
                      )}
                    </div>
                    {DONE && !isMobile && key !== ROADMAP.ITEMS.length - 1 && (
                      <div className="absolute -right-40 mr-2">
                        <Image
                          width={144}
                          height={4}
                          alt="line"
                  ...
                  <div className="flex desktop:items-center flex-col  gap-y-4">
                    <h3 className="desktop:text-xl text-lg font-semibold">
                      {data.TITLE}
                    </h3>
